...
const VITEPRESS_COPY_CODE_INITIALIZED_KEY = '__VITEPRESS_COPY_CODE_INITIALIZED__'

export function useCopyCode() {
  if (inBrowser && !(window as any)[VITEPRESS_COPY_CODE_INITIALIZED_KEY]) {
    (window as any)[VITEPRESS_COPY_CODE_INITIALIZED_KEY] = true
    ...
    window.addEventListener('click', (e) => {
      ...
      if (el.matches('div[class*="language-"] > button.copy')) {
        ...
        copyToClipboard(text).then(() => {
          ...
          const currentTimeoutId = timeoutIdMap.get(el)
